    ...
    <form method="post" class="row g-2" enctype="multipart/form-data">
        ...
        <div class="col-md-4">
            <div class="mb-2">
                ...
                <img src="<?php echo !empty($user['profile_picture']) ? htmlspecialchars($user['profile_picture']) : 'https://ui-avatars.com/api/?name=' . urlencode($user['first_name'] . ' ' . $user['last_name']) . '&background=8d288f&color=fff&size=128'; ?>"
